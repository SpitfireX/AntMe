...
namespace AntMe.Player.TeamA
{
    ...
    /// </summary>
    [Spieler(
        Volkname = "TeamA",   // Hier kannst du den Namen des Volkes festlegen
    ...
    public class TeamAKlasse : Basisameise
    {
        MeineAmeise ich;
