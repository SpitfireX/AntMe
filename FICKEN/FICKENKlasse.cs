...
namespace AntMe.Player.FICKEN
{
    ...
    /// </summary>
    [Spieler(
        Volkname = "FICKEN",   // Hier kannst du den Namen des Volkes festlegen
    ...
    public class FICKENKlasse : Basisameise
    {
        Spielobjekt festesZiel, aktuellesZiel, bau;
        bool scoutErfolg, apfelGefunden, zuckerGefunden;
        ...
        public override string BestimmeKaste(Dictionary<string, int> anzahl)
        {
            ...
            return gesamtzahl % 10 == 0 ? "Scout" : "Standard";
        }
        ...
        public override void Tick()
        {
            ...
            if (Kaste == "Scout")
            {
                if (scoutErfolg)
                {
                    if (zuckerGefunden)
                    {
                        SprüheMarkierung(CombineMarker(markerTypes["Zucker"], (short)(Richtung - 180)), 2);
                    }
                    else if (apfelGefunden)
                    {
                        SprüheMarkierung(CombineMarker(markerTypes["Apfel"], (short)(Richtung - 180)), 2);
                    }
                }
                else
                {
            ...
            else
            {
                ...
                {
                    SprüheMarkierung(CombineMarker(markerTypes["Apfel"], (short)(Richtung - 180)), 50);
                }
                else if (AktuelleLast == 0 && festesZiel != null)
                {
                    SprüheMarkierung(CombineMarker(markerTypes["Zucker"], (short)(Richtung - 180)), 50);
                }
            }
        }
        ...
        {
            string typ = MarkerType(markierung.Information);
            short nachricht = MarkerMessage(markierung.Information);

            if (Kaste == "Scout")
            {
                if (typ == "Scout" && !scoutErfolg)
                {
                    DreheUmWinkel(10);
                }
            }
            ...
            {
                if (festesZiel == null && AktuelleLast == 0 && (typ == "Zucker" || typ == "Apfel"))
                {
